...
export const useGetMovieDetailsSwitch = (moveId: string | number, internal: boolean) => {
  ...
  const movieDetails: Movie = {
    ...
    poster_path: internalMovieRef.data?.poster_path || externalMovieRef.data?.poster_path || "",
    overview: internalMovieRef.data?.overview || externalMovieRef.data?.overview || "", 
    release_date: internalMovieRef.data?.release || externalMovieRef.data?.release_date || "",
    backdrop_path: internalMovieRef.data?.backdrop_path || externalMovieRef.data?.backdrop_path || ""
  }
  return {hasInternalRef: !!internalMovieRef.data, movieDetails}
};
